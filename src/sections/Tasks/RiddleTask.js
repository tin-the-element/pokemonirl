    ...
    useEffect(() => {
      const fetchProblem = async () => {
        try {
          ...
          const riddleTask = await API.graphql({query: queries.getRiddleTask, variables: {id: id}})
      ...
      }, [id, loading, turnsLeft, riddleTaskData.turns_permitted, riddleTaskData.total_hp, usersPokemons, selectedPokemon, history, riddleTaskData.exp_given, riddleTaskData.lose_quote, riddleTaskData.name, riddleTaskData.win_quote])
    ...
    return(
      <div class="battle_div">
        ...
        <div class="problem">
            ...
            <div id="battle_div" style={{backgroundImage: 'url(/assets/riddle_tasks/' + riddleTaskData['images'] + ".jpg"}}>
              <img id="battle_image" class="battle_image" alt={riddleTaskData.name} src={'/assets/riddle_tasks/' + riddleTaskData['images'] + ".jpg"}></img>
