  ...
  return (
    <div className="center-div">
      ...
      <div className="final_paragraph">
        <h3>
          Like the real world, we won't show you how to do correctly do stuff,
          however, we will give you a lot of information to help you while you
          play the game along with it!
        </h3>
