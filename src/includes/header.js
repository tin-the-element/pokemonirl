    ...
    <div className="dropdown">
      ...
      {accountData !== null ? (
        ...
        <div style={{ height: "87px" }}>
          <MoonLoader color={"white"} loading={"true"} size={60} />
        </div>
      )}

      <DropdownItem leftIcon={pokeball_icon} link="/user_pokemon">
        <h3 className="dropdown-text">Your Pokemon!</h3>
      </DropdownItem>
      <DropdownItem leftIcon={leaderboard_icon} link="/leaderboard">
        <h3 className="dropdown-text">Leaderboard</h3>
      </DropdownItem>
      <li className="navbar-section">
...
function TaskMenu() {
  ...
  return (
    <div style={{ right: "25px" }} className="dropdown">
      ...
      <DropdownItem leftIcon={list_tasks_icon} link="/list_tasks">
        <h3 className="dropdown-text">List Tasks</h3>
      </DropdownItem>
    </div>
  );
}
...
function InventoryMenu() {
  ...
  return (
    <div style={{ right: "5px" }} className="dropdown">
      ...
      <DropdownItem leftIcon={store_icon} link="/store">
        <h3 className="dropdown-text">Store</h3>
      </DropdownItem>
    </div>
  );
}
